...
Converters.register_converter(
    from_type=Spelled.Pitch, to_type=Enharmonic.Pitch, conv_func=convert_spelled_to_enharmonic
)
Converters.register_converter(
    from_type=Spelled.Interval, to_type=Enharmonic.Interval, conv_func=convert_spelled_to_enharmonic
)
Converters.register_converter(
    from_type=Spelled.PitchClass, to_type=Enharmonic.PitchClass, conv_func=convert_spelled_to_enharmonic
)
Converters.register_converter(
    from_type=Spelled.IntervalClass, to_type=Enharmonic.IntervalClass, conv_func=convert_spelled_to_enharmonic
)


Converters.register_converter(
    from_type=Enharmonic.Pitch, to_type=LogFreq.Pitch, conv_func=lambda enharmonic: enharmonic.convert_to_log_freq()
)
Converters.register_converter(
    from_type=Enharmonic.Interval,
    to_type=LogFreq.Interval,
    conv_func=lambda enharmonic: enharmonic.convert_to_log_freq(),
)
Converters.register_converter(
    from_type=Enharmonic.PitchClass,
    to_type=LogFreq.PitchClass,
    conv_func=lambda enharmonic: enharmonic.convert_to_log_freq(),
)
Converters.register_converter(
    from_type=Enharmonic.IntervalClass,
